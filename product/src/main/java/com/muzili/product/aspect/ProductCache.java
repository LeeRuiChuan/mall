...
public class ProductCache {
     ...
     */
    @AfterReturning(value = "execution(* com.muzili.product.service.ProductService*.*Product(..))", returning = "result")
     ...
     * @param result 切入点返回值
     */
    @AfterReturning(value = "execution(* com.muzili.product.service.ProductService*.queryByProductId(..))", returning = "result")
